...
def portfolio():
    portfolios = [
            ...
            {'name': 'Ninja Gold', 'url': 'https://github.com/stradtkt/Ninja-Gold-Python', 'desc': 'This was made as a part of the coding dojo program. Get the most gold!', 'img': 'cave2.jpg', 'video': 'ninja-1.mp4', 'languages': ['Python', 'Flask', 'Bootstrap', 'CSS', 'HTML'],  'tag': 'Flask'},
            {'name': 'Pagination + Search', 'url': 'https://github.com/stradtkt/Pagination', 'desc': 'This is a project to show how javascript can influence pagination and search bars', 'img': 'pag.png', 'video': 'student-1.mp4', 'languages': ['JavaScript', 'jQuery', 'Bootstrap', 'CSS', 'HTML'], 'tag': 'JavaScript'},
...
def testimonials():
    testimonial = [
        ...
        {'name': 'Makayla', 'job': 'Account Manager', 'description': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor accusamus voluptatum vel recusandae laborum atque deleniti consectetur saepe in tempore, ad, sed ab temporibus velit modi! At dolorem laboriosam deleniti commodi. Fugiat expedita veniam molestias distinctio deserunt esse soluta assumenda, dolorum corrupti itaque magnam? Modi molestiae quam vitae deserunt commodi?', 'img': 'marie.jpg'},
        {'name': 'Patrick', 'job': 'Account Manager', 'description': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor accusamus voluptatum vel recusandae laborum atque deleniti consectetur saepe in tempore, ad, sed ab temporibus velit modi! At dolorem laboriosam deleniti commodi. Fugiat expedita veniam molestias distinctio deserunt esse soluta assumenda, dolorum corrupti itaque magnam? Modi molestiae quam vitae deserunt commodi?', 'img': 'mike.jpg'},
        {'name': 'John', 'job': 'SVP', 'description': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor accusamus voluptatum vel recusandae laborum atque deleniti consectetur saepe in tempore, ad, sed ab temporibus velit modi! At dolorem laboriosam deleniti commodi. Fugiat expedita veniam molestias distinctio deserunt esse soluta assumenda, dolorum corrupti itaque magnam? Modi molestiae quam vitae deserunt commodi?', 'img': 'michael.jpg'},
        {'name': 'Eric', 'job': 'Web Developer', 'description': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor accusamus voluptatum vel recusandae laborum atque deleniti consectetur saepe in tempore, ad, sed ab temporibus velit modi! At dolorem laboriosam deleniti commodi. Fugiat expedita veniam molestias distinctio deserunt esse soluta assumenda, dolorum corrupti itaque magnam? Modi molestiae quam vitae deserunt commodi?', 'img': 'ryan.jpg'},
        {'name': 'Lauren', 'job': 'Designer', 'description': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor accusamus voluptatum vel recusandae laborum atque deleniti consectetur saepe in tempore, ad, sed ab temporibus velit modi! At dolorem laboriosam deleniti commodi. Fugiat expedita veniam molestias distinctio deserunt esse soluta assumenda, dolorum corrupti itaque magnam? Modi molestiae quam vitae deserunt commodi?', 'img': 'olivia.jpg'},
    ]
